...
Build notifications for key booking events: confirmation, cancellation, payment received. Each notification goes to multiple channels (email + database + optionally SMS) with different content per channel.
