...
class OrderNotificationController extends Controller
{
    ...
    public function store(OrderData $orderData, CreateOrderAction $action)
    {
        ...
        // Dispatch notification after order is created to the user
        $order->user->notify(new OrderCreatedNotification($order));

        return $this->successResponse(new OrderResource($order), 'Order created successfully and notifications dispatched.', 201);
    }
